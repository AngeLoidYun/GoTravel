...
public class CityListAdapter extends RecyclerView.Adapter<CityListAdapter.BaseViewHolder> {
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position) {
        ...
        if (holder instanceof LocationViewHolder){
            ...
            int itemWidth = (screenWidth - padding - space * (PickerGridListAdapter.SPAN_COUNT - 1) - indexBarWidth) / PickerGridListAdapter.SPAN_COUNT;
        ...
        if (holder instanceof HotViewHolder){
            ...
            final City data = mData.get(pos);
            if (data == null) return;
            PickerGridListAdapter mAdapter = new PickerGridListAdapter(mContext, mHotData);
    ...
    public static class HotViewHolder extends BaseViewHolder {
        ...
        HotViewHolder(View itemView) {
            ...
            mRecyclerView.addItemDecoration(new GridItemDecoration(PickerGridListAdapter.SPAN_COUNT,
                    space));
        }
    }
