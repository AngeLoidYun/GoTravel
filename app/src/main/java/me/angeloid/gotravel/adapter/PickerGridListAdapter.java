...
public class PickerGridListAdapter extends RecyclerView.Adapter<PickerGridListAdapter.GridViewHolder>{
    ...
    public PickerGridListAdapter(Context context, List<HotCity> data) {
